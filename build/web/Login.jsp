                        ...
                        <form action="Register" method="post">
                            <div class="modal-body" >
                                ...
                                <div class="md-form form-sm mb-5">
                                    ...
                                    <input type="text" name="username" id="modalLRInput13" class="form-control form-control-sm validate">
                                    <label data-error="wrong" data-success="right" for="modalLRInput13">User Name</label>
                                </div>

                                <div class="md-form form-sm mb-5">
                                    <i class="fas fa-lock prefix"></i>
                                    <input type="password" name="password" id="modalLRInput15" class="form-control form-control-sm validate">
                                ...
                                <div class="text-center form-sm mt-2">
                                    <button class="btn btn-info" type="submit">Register<i class="fas fa-sign-in ml-1"></i></button>
                                </div>
                            </div>
                        </form>
                        <!--Footer-->
